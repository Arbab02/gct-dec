    ...
    <div className="container mx-auto py-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {classesData.map((classItem, index) => (
          <motion.div
            key={index}
            className="bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-gray-800 via-gray-950 to-gray-950 p-6 rounded-lg shadow-lg text-gray-400"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 * index, duration: 0.5 }}
          >
            <div className="w-3/4 mx-auto p-3 bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-gray-950 via-gray-950 to-gray-800 rounded-full">
              <img
            ...
            <div className="bg-[transparent] rounded p-6 pt-8 mt-[-30px]">
              <a
                href="#"
                className="block text-center text-xl font-semibold text-gray-400 mt-3 mb-4"
              >
                {classItem.title}
              </a>
